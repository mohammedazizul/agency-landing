import DownArrowSVG from "./svg/icon/DownArrowSVG";
import UpArrowSVG from "./svg/icon/UpArrowSVG";

function FaqOpenBtn({ btnTxt }) {
  return (
    <button
      type="button"
        ...
        <div className="max-w-screen-md mx-auto">
          ...
          >
            <h3 id="accordion-flush-heading-1">
              <FaqCloseBtn
                btnTxt={"Can I use Landwind in open-source projects?"}
              />
            </h3>
            <div
            ...
            <h3 id="accordion-flush-heading-2">
              <FaqOpenBtn btnTxt={"Is there a Figma file available?"} />
            </h3>
            <div
            ...
            <h3 id="accordion-flush-heading-4">
              <FaqOpenBtn btnTxt={"What about browser support?"} />
            </h3>
            <div
